...
************************************************************************************************************/	
	...
	var CPImageFolder = '/themes/default/images/colorpicker/';
	var form_widget_amount_slider_handle = CPImageFolder + 'slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = CPImageFolder + "tab_right_active.gif";
					...
					img.src = CPImageFolder + "tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = CPImageFolder + "tab_right_" + suffix + ".gif";
	...
	function showColorPicker(inputObj,formField)
	{
		...
		color_picker_div.style.top = colorPickerGetTopPos(inputObj) + inputObj.offsetHeight - getScrollTop() + 2 + 'px';
	...
	function getScrollTop() {
		...
		return frame ? frame.scrollTop : 0;
	}
