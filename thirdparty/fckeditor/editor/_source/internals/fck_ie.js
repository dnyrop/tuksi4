...
FCK._ExecPaste = function()
{
	...
	if ( sHTML === false )
		FCKTools.RunFunction( FCKDialog.OpenDialog, FCKDialog, ['FCKDialog_Paste', FCKLang.Paste, 'dialog/fck_paste.html', 500, 300, 'Security'] ) ;
	else
	{
...
FCK.PasteAsPlainText = function( forceText )
{
	...
	{
		FCKDialog.OpenDialog( 'FCKDialog_Paste', FCKLang.PasteAsText, 'dialog/fck_paste.html', 500, 300, 'PlainText' ) ;
		return ;
	}
