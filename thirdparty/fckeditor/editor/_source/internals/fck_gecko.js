...
FCK.ExecuteRedirectedNamedCommand = function( commandName, commandParameter )
{
	switch ( commandName )
	{
		...
		case 'Paste' :
			...
			catch (e)	{ FCKDialog.OpenDialog( 'FCKDialog_Paste', FCKLang.Paste, 'dialog/fck_paste.html', 500, 300, 'Security' ) ; }
			break ;
		default :
...
FCK.PasteAsPlainText = function()
{
	...
	FCKTools.RunFunction( FCKDialog.OpenDialog, FCKDialog, ['FCKDialog_Paste', FCKLang.PasteAsText, 'dialog/fck_paste.html', 500, 300, 'PlainText'] ) ;
