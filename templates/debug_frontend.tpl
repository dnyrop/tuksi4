<div class="tuksi_debug" id="tuksi_debug">
<div>
	<div class="windowHeader">
		<h5><span>Debug</span></h5>
	</div>
	<div class="windowInner">
		<div class="windowInnerPadding">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<td><a href="http://{$conf.site.url_prodsite}/tuksi/?treeid={$tuksi_debug.info.treeid}">{$tuksi_debug.info.treeid}</a></td>
					</tr>
					<tr>
						<td width="120">
							<strong>Cache</strong>
						</td>
						<td>{$tuksi_debug.info.cache}</td>
					</tr>
					<tr>
						<td width="120">
							<strong>Emulate prod</strong>
						</td>
						<td>{$tuksi_debug.info.emulateprod}</td>
					</tr>
					<tr>
						<td width="120">
			...
			<a href="#" class="buttonType3" onclick="tuksi_debug.showPanel();return false;"><span><span>Show debug</span></span></a>
	</div>
</div></div></div>
