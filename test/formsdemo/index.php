...
<head>
	...
	<script type="text/javascript" src="../../core/thirdparty/swfupload/swfupload.js"></script>
	...
	<script type="text/javascript">
        ...
        window.onload = function () {
            swf_upload_control = new SWFUpload({
				// Backend settings
				upload_url: "../../services/upload.php",	// Relative to the SWF file, you can use an absolute URL as well.
				...
				// Flash Settings
				flash_url : "../../core/thirdparty/swfupload/swfupload_f9.swf",	// Relative to this file
